        ...
        switch arg
            ...
            case 'X11'      % compute trend-cycle and seasonality using X11
                spec = x13spec(spec, ...
                    ...
                    'x11',   'save',        '(e2 e3 d8 d10 d11 d12 d13 d16)');
%                    'x11',   'appendfcst',  'yes', ...

            case 'FULLX11'  % more complete selection of saved variables
                spec = makespec(spec, 'X11', ...
                    'x11',   'save',   ...
                        ['(ars bcf chl d8 d10 d11 d12 d13 d16 d18 ', ...
                         'd8 d8b d9 e1 e11 e18 e2 e3 ', ...
            ...
            case 'FIXEDSEASONAL'    % compute fixed seasonal pattern
                                    % with simple method
                spec = x13spec(spec,'fixedseas',{},{});

            case 'CAMPLET'          % compute seasonal pattern using CAMPLET
                                    % argorithm
                spec = x13spec(spec,'camplet',{},{});
