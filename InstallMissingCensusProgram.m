...
%   Downloading 'x13as_V1.1_B26.zip' from US Census Bureau website ... success.
%   Downloading 'x13ashtml_V1.1_B26.zip' from US Census Bureau website ... success.
...
%         'loc',      {'exe', 'doc', 'doc'});
    ...
    if nargin == 0  % install everything in that case
        varargin = legal(1:end-5);  % all up to x12doc
    elseif ismember('all',varargin)
        varargin = legal;           % all, incl x11 ... cnv
    end
