...
% a timeseries object ('ts') containing a single time series.
%
...
%    x = x13(data, spec, '-s'), or
%    x = x13(data, spec, '-s', '-w'), or
%    x = x13(data, spec, '-s -w'),
% or x = x13(data, spec, 'noflags')
...
%   x = x13([dates,data],spec,compositespec)
%   x = x13([dates,data],{spec1,spec2,...},compositespec)
%   x = x13(ts,spec,compositespec)
%   x = x13(ts,{spec1,spec2,...},compositespec)
%   x = x13(ts,spec1,[dates,data],spec2,compositespec)
%   x = x13(..., 'x-12')
%   x = x13(..., 'x-13')
%   x = x13(..., 'html')
%   x = x13(..., '-s', '-c', '-w', ... etc)
